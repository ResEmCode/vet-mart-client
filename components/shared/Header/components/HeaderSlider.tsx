...
export function HeaderSlider() {
  ...
  return (
    ...
    <CarouselPrevious className="absolute left-4 transform bg-gray-300 rounded-full shadow-md hover:bg-gray-400">
      ←
    </CarouselPrevious>
    <CarouselNext className="absolute right-4 transform  bg-gray-300 rounded-full shadow-md hover:bg-gray-400">
      →
    </CarouselNext>
  </Carousel>
  )
